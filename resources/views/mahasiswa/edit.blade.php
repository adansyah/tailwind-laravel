                                ...
                                <form action="/mahasiswa/{{ $mahasiswa->id }}/update" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama" id=""
                                            placeholder="Masukan nama" value="{{ $mahasiswa->nama }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="">nim</label>
                                        <input type="text" class="form-control" name="nim" id=""
                                            placeholder="Masukan nim" value="{{ $mahasiswa->nim }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="">alamat</label>
                                        <input type="text" class="form-control" name="alamat" id=""
                                            placeholder="Masukan Alamat" value="{{ $mahasiswa->alamat }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="">telp</label>
                                        <input type="text" class="form-control" name="telp" id=""
                                            placeholder="Masukan telp" value="{{ $mahasiswa->telp }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="">jurusan</label>
                                        <input type="text" class="form-control" name="jurusan" id=""
                                            placeholder="Masukan jurusan" value="{{ $mahasiswa->jurusan }}" required>
                                    </div>

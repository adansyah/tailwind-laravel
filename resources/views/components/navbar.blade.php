        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <img class="h-8 w-8" src="assetz/img/clients/thxfather.png" alt="Your Company">
                </div>
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/about"
                            class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Biodata</a>
                        <a href="/mahasiswa"
                            class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Data
                            Mahasiswa</a>
                        <a href="/book"
                            class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Book
                            List</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="relative ml-3">
                        <div>
                            <button type="button" @click="isOpen = !isOpen"
                                ...
                                <img class="h-8 w-8 rounded-full" src="assetz/img/team/sahdan.jpeg" alt="">
                            </button>
                        </div>
        ...
        -->
                            ...
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem"
                                ...
                                <button type="submit">
                                    <a class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
                                        id="user-menu-item-2">Log out &raquo;</a>
                                </button>
                            </div>
                        </form>
                    </div>
            ...
            <div class="-mr-2 flex md:hidden">
                ...
                <button type="button" @click="isOpen = !isOpen"
                    ...
                    <svg :class="{ 'hidden': isOn, 'block': !isOpen }" class="block h-6 w-6" fill="none"
                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                    </svg>
                    <!-- Menu open: "block", Menu closed: "hidden" -->
                    <svg :class="{ 'block': isOn, 'hidden': !isOpen }" class="hidden h-6 w-6" fill="none"
                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
